	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main">
            <section class="lessons">
                    <div class="hero">
                        <img class="darken" src="<?php echo get_template_directory_uri(); ?>/public/img/banners/banner-lessons.jpg" alt="Lessons Banner">
